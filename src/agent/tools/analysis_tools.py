...
def _handle_analyze_trend(stock_code: str) -> dict:
    ...
    return {
        ...
        "ma_spread_pct": round(result.ma_spread_pct, 2),
        "ma20_slope_pct": round(result.ma20_slope_pct, 2),
        "price_return_20d": round(result.price_return_20d, 2),
        "ma5": result.ma5,
        "ma10": result.ma10,
        "ma20": result.ma20,
        "ma60": result.ma60,
        ...
        "macd_momentum": round(result.macd_momentum, 4),
